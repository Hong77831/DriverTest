// DPCTimer.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    {
        wprintf(L"Failed to obtain file handle to device: %S with Win32 erro code: %d\n", "MyWDMDevice", GetLastError());
        return 1;
    }
